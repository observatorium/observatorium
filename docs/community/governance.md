...
* **Maintainers Team**: A core Observatorium team that have owner access to http://github.com/observatorium organization and all projects within it. Current list is available [here][maintainers-doc].
...
New members may be proposed by any existing Maintainer by email to [Observatorium][team]. It is highly desirable to reach consensus about acceptance of a new member.
...
This email will also be CC'd to [Observatorium][team] for record-keeping purposes.

If they choose to accept, the following steps are taken:

* Maintainer is added to the [GitHub organization][gh] as _Owner_.
* Maintainer is added to the [Observatoriumo][team].
...
Team members may retire at any time by emailing [observatorium-team@googlegroups.com][team].

Team members can be removed by [supermajority vote](#supermajority-vote) on [observatorium-team@googlegroups.com][team]. For this vote, the member in question is not eligible to vote and does not count towards the quorum.
...
Material changes to this document are discussed publicly on the [Observatorium GitHub](http://github.com/observatorium/observatorium).
...
For financial, private, or personnel matters, discussion and voting takes place on the [observatorium-team@googlegroups.com][team]; Otherwise discussion and votes are held in public on the GitHub issues or #observatorium-dev CNCF slack channel.
...
Discussion and votes on personnel matters (including but not limited to team membership and maintainership) are held in private on the [observatorium-team@googlegroups.com][team]. All other discussion and votes are held in public on the GitHub issues or #observatorium-dev CNCF slack channel.
...
We also encourage any other company interested in helping maintaining Observatorium to join us to make sure we stay independent.
...
As a team member, propose the new project on the [Observatorium GitHub Issue][issues]. However, currently to maintain project in our organization you have to become Observatorium Maintainers.

All are encourage to start their own project related to Observatorium. Observatorium team is happy to link to your poject in appriopriate page.

### How do I remove a Maintainer member?

All members may resign by notifying the [observatorium-team@googlegroups.com][team]. If you think a team member should be removed against their will, propose this to the [observatorium-team@googlegroups.com][team].
