  ...
  thanos+:: {
    template+:
      ...
      list.asList('thanos', objects, [
        ...
        { name: 'THANOS_QUERIER_MEMORY_REQUEST', value: '500Mi' },
        { name: 'THANOS_QUERIER_MEMORY_LIMIT', value: '1Gi' },
        { name: 'THANOS_STORE_CPU_REQUEST', value: '100m' },
        { name: 'THANOS_STORE_CPU_LIMIT', value: '"1"' },
        { name: 'THANOS_STORE_MEMORY_REQUEST', value: '500Mi' },
        { name: 'THANOS_STORE_MEMORY_LIMIT', value: '1Gi' },
        { name: 'THANOS_RECEIVE_CPU_REQUEST', value: '100m' },
        { name: 'THANOS_RECEIVE_CPU_LIMIT', value: '"1"' },
        { name: 'THANOS_RECEIVE_MEMORY_REQUEST', value: '500Mi' },
