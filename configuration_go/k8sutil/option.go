...
// ConfigFileVolume is a configuration file that must be consumed by the container.
...
// NewVolumeConfigFile creates a new VolumeConfigFile.
func NewVolumeConfigFile(volumeName, mountPath, filepath string) *ConfigFileVolume {
...
func (c *ConfigFile) Update(container *Container) {
	if c.resourceName == "" {
...
func addVolumeMountToContainer(container *Container, volumeName, mountPath string) {
