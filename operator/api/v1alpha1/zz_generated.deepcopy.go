...
func (in *MTLS) DeepCopyInto(out *MTLS) {
	*out = *in
	out.MTLSConfigMap = in.MTLSConfigMap
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MTLSConfigMap) DeepCopyInto(out *MTLSConfigMap) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MTLSConfigMap.
func (in *MTLSConfigMap) DeepCopy() *MTLSConfigMap {
	if in == nil {
		return nil
	}
	out := new(MTLSConfigMap)
	in.DeepCopyInto(out)
	return out
}
