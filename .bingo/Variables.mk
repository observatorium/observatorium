...
$(API): $(BINGO_DIR)/api.mod
	...
	@cd $(BINGO_DIR) && $(GO) build -mod=mod -modfile=api.mod -o=$(GOBIN)/api-v0.1.2 "github.com/observatorium/api"
...
OBSCTL := $(GOBIN)/obsctl-v0.0.0-20220317091519-3902e9ed1e2c
$(OBSCTL): $(BINGO_DIR)/obsctl.mod
	@# Install binary/ries using Go 1.14+ build command. This is using bwplotka/bingo-controlled, separate go module with pinned dependencies.
	@echo "(re)installing $(GOBIN)/obsctl-v0.0.0-20220317091519-3902e9ed1e2c"
	@cd $(BINGO_DIR) && $(GO) build -mod=mod -modfile=obsctl.mod -o=$(GOBIN)/obsctl-v0.0.0-20220317091519-3902e9ed1e2c "github.com/observatorium/obsctl"
